...
CREATE TABLE `tl_content` (
  `ce_slider_jquery_elemType` varchar(255) NOT NULL default '',
  ...
  `ce_slider_jquery_nextImg` varchar(255) NOT NULL default '',
  `ce_slider_jquery_prevImg` varchar(255) NOT NULL default '',
  ...
  `ce_slider_jquery_useSlide` char(1) NOT NULL default '',
  ...
  `ce_slider_jquery_useFade` char(1) NOT NULL default '',
  ...
  `ce_slider_jquery_effect_slide` varchar(255) NOT NULL default '',
  `ce_slider_jquery_effect_fade` varchar(255) NOT NULL default '',
  `ce_slider_jquery_crossfade` char(1) NOT NULL default '',
  `ce_slider_jquery_randomize` char(1) NOT NULL default '',
  `ce_slider_jquery_play` int(10) unsigned NOT NULL default '1',
